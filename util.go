...
// Returns a string for the provided pixelgl.GamepadButton
...
// Returns a string for the provided pixelgl.GamepadAxis
...
// Returns a string for the provided pixelgl.GamepadAxis with its sign
